  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-10 border-t border-gray-200 bg-white/95 px-3 py-2 backdrop-blur" aria-label="Student navigation">
      <div className="mx-auto flex w-full max-w-md items-center gap-1">
        ...
        <span className="flex min-h-12 flex-1 flex-col items-center justify-center px-2 text-center text-xs font-semibold text-gray-400" aria-disabled="true">Applications<br />Coming soon</span>
        <span className="flex min-h-12 flex-1 flex-col items-center justify-center px-2 text-center text-xs font-semibold text-gray-400" aria-disabled="true">Status<br />Coming soon</span>
      </div>
    </nav>
  );
}
