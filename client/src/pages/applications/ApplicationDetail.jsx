...
export default function ApplicationDetail() {
  ...
  useEffect(() => {
    let active = true;
    const load = async () => {
      try { const response = await getApplication(id); if (active) setApplication(response.data); }
      catch (requestError) { if (active) setError(requestError.response?.data?.message || 'Unable to load this application.'); }
